...
-- -----------------------------------------------------
-- Table `studydb`.`member`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `studydb`.`member` ;

CREATE TABLE IF NOT EXISTS `studydb`.`member` (
...
-- -----------------------------------------------------
-- Table `studydb`.`guestbook`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `studydb`.`guestbook` ;

CREATE TABLE IF NOT EXISTS `studydb`.`guestbook` (
  ...
  CONSTRAINT `guestbook_userid_fk`
    FOREIGN KEY (`userid`)
    REFERENCES `studydb`.`member` (`userid`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
AUTO_INCREMENT = 1
